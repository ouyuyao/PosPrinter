...
public class BluetoothListActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.printer_dialog_bluetooth_list);
    ...
    private void initBluetooth() {
        ...
        if (mBluetoothAdapter == null) {
            Toast.makeText(this, R.string.bluetooth_4_not_supported, Toast.LENGTH_SHORT).show();
        } else {
            // 检查蓝牙是否打开
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQUEST_ENABLE_BT) {
            if (resultCode == Activity.RESULT_OK) {
                ...
                Toast.makeText(this, R.string.bluetooth_not_enable, Toast.LENGTH_SHORT).show();
            }
        }
    }
    ...
    protected void getDeviceList() {
        ...
        mDevicesArrayAdapter = new ArrayAdapter<>(this, R.layout.printer_bluetooth_device_name_item);
        lvPairedDevice.setAdapter(mDevicesArrayAdapter);
        lvPairedDevice.setOnItemClickListener(mDeviceClickListener);
        // 已匹对数据
        Set<BluetoothDevice> pairedDevices = mBluetoothAdapter.getBondedDevices();
        // 添加一个item显示信息
        mDevicesArrayAdapter.add(this.getString(R.string.paired_printer_devices));
        if (pairedDevices.size() > 0) {
            ...
            mDevicesArrayAdapter.add(this.getString(R.string.unpaired_printer_devices));
        }
    }
    ...
    private final BroadcastReceiver mFindBlueToothReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (BluetoothDevice.ACTION_FOUND.equals(action)) {
                ...
                setTitle(getString(R.string.select_printer_bluetooth));
                //此处-2是减去我们手动添加的两个区分显示的item
                Log.i("tag", "finish discovery" + (mDevicesArrayAdapter.getCount() - 2));
                if (mDevicesArrayAdapter.getCount() == 0) {
                    mDevicesArrayAdapter.add(getString(R.string.not_find_printer_bluetooth));
                }
            }
        }
    };
    ...
    private void discoveryDevice() {
        ...
        setTitle(getString(R.string.scaning_printer_bluetooth_device));
        // 添加一个item区分显示信息
        mDevicesArrayAdapter.add(getString(R.string.unpaired_printer_bluetooth));
    ...
    private OnItemClickListener mDeviceClickListener = new OnItemClickListener() {
        ...
        public void onItemClick(AdapterView<?> av, View v, int arg2, long arg3) {
            ...
            String noDevices = getString(R.string.no_unpaired_printer_device);
            String noNewDevice = getString(R.string.no_unpaired_printer_bluetooth_device);
            Log.i("TAG", info);
